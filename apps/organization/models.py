...
class CourseOrg(models.Model):
    ...
    category = models.CharField(max_length=20, choices=(("pxjg", "培训机构"), ("gr", "个人"), ("gx", "高校")),
                                verbose_name=u'机构类别', default='pxjjg')
    tag = models.CharField(max_length=10, verbose_name=u'机构标签', null=True, blank=True)
    click_num = models.IntegerField(default=100, verbose_name=u'点击数')
    fav_num = models.IntegerField(default=100, verbose_name=u'收藏数')
...
class Teacher(models.Model):
    ...
    click_num = models.IntegerField(default=100, verbose_name=u'点击数')
    fav_num = models.IntegerField(default=100, verbose_name=u'收藏数')
    image = models.ImageField(upload_to='teacher/%Y/%m', verbose_name=u'头像', max_length=200, default=None)
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u'添加时间')
